...
export const defaultProject: GameProject = {
	...
	shops: [
		{
			...
			entries: [
				{
					id: "shop_entry_tavern_key",
					itemId: "tavern_key",
					buyPrice: 5,
					stock: 1,
				},
				{
					id: "shop_entry_rum_bottle",
					itemId: "rum_bottle",
					buyPrice: 2,
					stock: 3,
				},
	...
	quests: [
		{
			...
			description:
				"Collect enough coins, find the side-door key, and make your way into the tavern.",
			status: "active",
			objectives: [
				{
	...
	npcs: [
		...
		},
		{
			...
			name: "Bandit",
			description:
				"A hostile pirate keeping watch near the edge of the village.",
			mapAvatarId: "scout",
	...
	objects: [
		...
		},
		{
			id: "object_dock_marker",
			name: "Boat",
			description: "A simple boat that can sail on water in play mode.",
			category: "vehicle",
			widthTiles: 1,
			heightTiles: 1,
			blocksMovement: false,
	...
	rules: [
		...
		},
		{
			...
			actions: [
				{ type: "remove_item", itemId: "gold_coin", quantity: 5 },
				{
					type: "teleport",
					areaId: "area_house",
					eventBlockId: "spawn_house_entry",
				},
			],
		...
		},
		{
			...
			conditionTree: {
				...
				conditions: [
					{
						id: "condition_tavern_intro_seen",
						type: "flag_is",
						flag: "tavern_intro_seen",
						value: false,
					},
				],
			},
