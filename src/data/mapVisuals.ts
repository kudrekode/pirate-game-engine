...
export const terrainPresets: TerrainPreset[] = [
	...
	},
	{
		...
		textColor: "#4d3b14",
		walkable: true,
		movementRule: movementRule(true, "walk", 0.88),
		pattern: "sand",
	},
	{
		id: "water",
		...
		textColor: "#0c2b3b",
		walkable: false,
		movementRule: movementRule(false, "swim"),
		pattern: "water",
	},
	{
		id: "stone",
	...
	},
	{
		...
		textColor: "#2d1609",
		walkable: true,
		movementRule: movementRule(true, "walk", 1.04),
		pattern: "wood",
	},
	{
		id: "stone_floor",
	...
	},
	{
		...
		textColor: "#fff5f7",
		walkable: true,
		movementRule: movementRule(true, "walk", 0.94),
		pattern: "fabric",
	},
	{
		id: "indoor_wall",
	...
	},
	{
		...
		textColor: "#eef2f7",
		walkable: true,
		movementRule: movementRule(true, "walk", 0.9),
		pattern: "stone",
	},
	{
		id: "cave_wall",
...
export const overlayPresets: OverlayPreset[] = [
	{
		...
		color: "#9b6538",
		walkable: true,
		movementRule: movementRule(true, "walk", 1.05),
		pattern: "path",
	},
	{
		id: "hay_path",
		...
		color: "#d6b85c",
		walkable: true,
		movementRule: movementRule(true, "walk", 0.96),
		pattern: "path",
	},
	{
		id: "stone_road",
		...
		color: "#8a8f96",
		walkable: true,
		movementRule: movementRule(true, "walk", 1.2),
		pattern: "path",
	},
	{
		id: "wooden_planks",
...
export const defaultTileStyles = Object.fromEntries(
	terrainPresets.map((tile) => [
		tile.id,
		{ color: tile.color, label: tile.label },
	]),
);
...
export function getOverlayPreset(overlayId: string): OverlayPreset {
	return (
		overlayPresets.find((overlay) => overlay.id === overlayId) ??
		overlayPresets[0]
	);
}
...
export function getStructurePreset(structureId: string): StructurePreset {
	return (
		structurePresets.find((structure) => structure.id === structureId) ??
		structurePresets[0]
	);
}
